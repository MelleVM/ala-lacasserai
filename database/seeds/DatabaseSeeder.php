...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $roomitems = [
            ...
            ['id' => 3, 'room_number' => 1, 'clean' => true, 'floor' => 1, 'description' => 'This is a room description, you can update it in the admin panel', 'price' => 100, 'disc' => 5, 'state' => 'available', 'type' => 'single', 'title' => 'Fancy room title', 'rating' => 5, 'cover_image' => 'room-1.jpg'],
            ['id' => 4, 'room_number' => 1, 'clean' => true, 'floor' => 1, 'description' => 'This is a room description, you can update it in the admin panel', 'price' => 100, 'disc' => 5, 'state' => 'available', 'type' => 'single', 'title' => 'Fancy room title', 'rating' => 5, 'cover_image' => 'room-1.jpg'],
